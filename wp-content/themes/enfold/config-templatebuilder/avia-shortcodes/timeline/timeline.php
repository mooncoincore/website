...
if( ! class_exists( 'avia_sc_timeline' ) ) 
{
    class avia_sc_timeline extends aviaShortcodeTemplate
    {
        ...
        function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
        {
            ...
            if( $custom_date_size ) 
			{
				$this->date_styling['font-size'] = $custom_date_size;
			}
			
            if( $custom_title_size ) 
			{
				$this->title_styling['font-size'] = $custom_title_size;
			}
			
            if( $custom_content_size ) 
			{
				$this->content_styling['font-size'] = $custom_content_size;
			}
            ...
            if( $font_color == 'custom' ) 
			{
				...
				{
					$this->date_styling['color'] = $custom_date;
				}
            ...
            if( $icon_color == 'custom' ) 
			{
                ...
                if( ! empty( $icon_custom_font ) ) 
				{
					$this->icon_styling['color'] = $icon_custom_font;
				}
				
                if( ! empty( $icon_custom_border ) ) 
				{
					$this->icon_styling['border-color'] = $icon_custom_border;
				}
            }
			...
			{
                if( $custom_contentbox_bg_color) 
				{
					$this->contentbox_styling['background-color'] = $custom_contentbox_bg_color;
				}
            }
        ...
        public function av_timeline_item( $atts, $content = '', $shortcodename = '' )
        {
		   ...
		   $default = array(
            ...
            $atts = shortcode_atts( $default, $atts, 'av_timeline_item' );
			...
			$customclass = ! empty( $atts['custom_class'] ) ? AviaHelper::save_classes_string( $atts['custom_class'], '-', 'invalid-custom-class-found' ) : '';

			$output = '';
            $output .= "<li {$customid} class='av-milestone av-animated-generic fade-in {$list_class} {$vertical_alignment} {$customclass}'>";
