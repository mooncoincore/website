...
if( ! class_exists( 'avia_breadcrumb' ) )
{
	...
	{
		_deprecated_constructor( 'avia_breadcrumb', '4.8.2' );
...
{
	_deprecated_function( 'avia_breadcrumbs', '4.8.2', 'Avia_Breadcrumb_Trail()->get_trail( $args )' );
...
{
	_deprecated_function( 'avia_breadcrumbs_get_parents', '4.8.2', 'Avia_Breadcrumb_Trail()->breadcrumbs_get_parents()' );
...
{
	_deprecated_function( 'avia_breadcrumbs_get_term_parents', '4.8.2', 'Avia_Breadcrumb_Trail()->breadcrumbs_get_term_parents()' );
...
{
	_deprecated_function( 'avia_make_unique_breadcrumbs', '4.8.2', 'Avia_Breadcrumb_Trail()->make_unique_breadcrumbs()' );
