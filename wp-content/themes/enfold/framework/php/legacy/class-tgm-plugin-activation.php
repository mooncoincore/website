<?php
/**
 * Was used in old themes only - kept in case used by users to know, we had integrated it
 * 
 * @deprecated since 4.8.3
 */
...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        public function __construct() {
			...
			_deprecated_constructor( 'TGM_Plugin_Activation', '4.8.3' );
            ...
            $this->strings = array(
                ...
                'activated_successfully'         => _n_noop( 'The following plugin was activated successfully:', 'The following plugins were activated successfully:', 'tgmpa' ),
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( '<div id="message" class="updated"><p>%1$s %2$s.</p></div>', translate_nooped_plural( TGM_Plugin_Activation::$instance->strings['activated_successfully'], $count, 'tgmpa' ), $imploded );
                }
